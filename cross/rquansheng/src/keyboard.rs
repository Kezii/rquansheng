...
impl QuanshengKey {
    pub fn as_ascii_char(&self) -> Option<char> {
        match self {
            QuanshengKey::Num0 => Some('0'),
            QuanshengKey::Num1 => Some('1'),
            QuanshengKey::Num2 => Some('2'),
            QuanshengKey::Num3 => Some('3'),
            QuanshengKey::Num4 => Some('4'),
            QuanshengKey::Num5 => Some('5'),
            QuanshengKey::Num6 => Some('6'),
            QuanshengKey::Num7 => Some('7'),
            QuanshengKey::Num8 => Some('8'),
            QuanshengKey::Num9 => Some('9'),
            _ => None,
        }
    }
}
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, defmt::Format)]
pub enum KeyEvent {
    KeyPressed(QuanshengKey),
    KeyReleased(QuanshengKey),
}
...
pub struct KeyboardState {
    last_key: Option<QuanshengKey>,
    pending: Option<KeyEvent>,
}

impl KeyboardState {
    pub fn eat_key(&mut self, key: Option<QuanshengKey>) -> Option<KeyEvent> {
        if let Some(ev) = self.pending.take() {
            return Some(ev);
        }

        let cur = key;
        match (self.last_key, cur) {
            (None, None) => None,
            (None, Some(k)) => {
            ...
            (Some(prev), Some(k)) => {
                ...
                self.last_key = Some(k);
                self.pending = Some(KeyEvent::KeyPressed(k));
                Some(KeyEvent::KeyReleased(prev))
            }
        }
    }
...
const KEYBOARD: [KeyboardRow; 5] = [
    KeyboardRow {
        ...
        pins: [
            KeyPin {
                key: Some(QuanshengKey::Side1),
                pin: GPIOA_PIN_KEYBOARD_0,
            },
            KeyPin {
                key: Some(QuanshengKey::Side2),
    ...
    KeyboardRow {
        ...
        pins: [
            KeyPin {
                key: Some(QuanshengKey::Menu),
                pin: GPIOA_PIN_KEYBOARD_0,
            },
            KeyPin {
                key: Some(QuanshengKey::Num1),
                pin: GPIOA_PIN_KEYBOARD_1,
            },
            KeyPin {
                key: Some(QuanshengKey::Num4),
                pin: GPIOA_PIN_KEYBOARD_2,
            },
            KeyPin {
                key: Some(QuanshengKey::Num7),
    ...
    KeyboardRow {
        ...
        pins: [
            KeyPin {
                key: Some(QuanshengKey::Up),
                pin: GPIOA_PIN_KEYBOARD_0,
            },
            KeyPin {
                key: Some(QuanshengKey::Num2),
                pin: GPIOA_PIN_KEYBOARD_1,
            },
            KeyPin {
                key: Some(QuanshengKey::Num5),
                pin: GPIOA_PIN_KEYBOARD_2,
            },
            KeyPin {
                key: Some(QuanshengKey::Num8),
                pin: GPIOA_PIN_KEYBOARD_3,
            },
        ],
    },
    KeyboardRow {
        ...
        pins: [
            KeyPin {
                key: Some(QuanshengKey::Down),
                pin: GPIOA_PIN_KEYBOARD_0,
            },
            KeyPin {
                key: Some(QuanshengKey::Num3),
                pin: GPIOA_PIN_KEYBOARD_1,
            },
            KeyPin {
                key: Some(QuanshengKey::Num6),
                pin: GPIOA_PIN_KEYBOARD_2,
            },
            KeyPin {
                key: Some(QuanshengKey::Num9),
                pin: GPIOA_PIN_KEYBOARD_3,
            },
        ],
    },
    KeyboardRow {
        ...
        pins: [
            KeyPin {
                key: Some(QuanshengKey::Exit),
                pin: GPIOA_PIN_KEYBOARD_0,
            },
            KeyPin {
                key: Some(QuanshengKey::Star),
                pin: GPIOA_PIN_KEYBOARD_1,
            },
            KeyPin {
                key: Some(QuanshengKey::Num0),
                pin: GPIOA_PIN_KEYBOARD_2,
            },
            KeyPin {
                key: Some(QuanshengKey::F),
                pin: GPIOA_PIN_KEYBOARD_3,
            },
        ],
    },
...
impl Keyboard {
    ...
    pub fn poll<D: DelayNs>(&mut self, delay: &mut D) -> Option<QuanshengKey> {
        let gpioa = unsafe { &*pac::GPIOA::ptr() };

        let mut key: Option<QuanshengKey> = None;
